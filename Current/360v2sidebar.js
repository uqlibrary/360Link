...
if (document.getElementsByClassName("custom-links-header").length != 0) {
	...
	document.getElementsByClassName("custom-link-group")[0].innerHTML = "<a target='_blank' href='http://cf5pm8sz2l.search.serialssolutions.com/?SS_searchTypeAll=yes&SS_searchTypeBook=yes&SS_searchTypeJournal=yes&SS_searchTypeOther=yes&V=1.0&N=100&L=CF5PM8SZ2L&S=AC_T_B&C=" + nameOfItem[1] + "'>Check if we have this item online</a><br><a target='_blank' href='https://app.library.uq.edu.au/#/journals?C=hydro" + nameOfItem[1] + "&S=AC_T_B'>Check if we have this item in print</a><br> <a target='_blank' href='" + requestDocDelURL + "'>Request the item via Document Delivery</a><br>";
